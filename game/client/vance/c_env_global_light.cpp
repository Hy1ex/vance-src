...
C_GlobalLight::C_GlobalLight() :
	m_angSunAngles( vec3_angle ), m_vecLight( vec3_origin ), m_vecAmbient( vec3_origin ), m_bCascadedShadowMappingEnabled( false ), m_bEnableDynamicSky( false ), m_flDayNightTimescale( 1.0f )
{
}
