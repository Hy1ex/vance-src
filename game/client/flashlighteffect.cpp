...
#ifdef HL2_CLIENT_DLL
	C_BaseHLCombatWeapon *pWeapon = (C_BaseHLCombatWeapon *)C_BasePlayer::GetLocalPlayer()->GetActiveWeapon();
	if ( pWeapon )
		UpdateMuzzleFlashTexture( nullptr );
#endif
														...
														const Vector &vecRight, const Vector &vecUp, bool castsShadows, bool bTracePlayers )
{
	...
	if ( hl2_episodic.GetBool() && pPlayer )
	{
