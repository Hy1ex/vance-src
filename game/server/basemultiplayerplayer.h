...
public:
	...
	virtual bool			SpeakIfAllowed( AIConcept_t conceptId, const char *modifiers = NULL, char *pszOutResponseChosen = NULL, size_t bufsize = 0, IRecipientFilter *filter = NULL );
