...
public:
	...
	void SetSpokeConcept( AIConcept_t conceptId, AI_Response *response, bool bCallback = true ) 		{ this->GetExpresser()->SetSpokeConcept( concept, response, bCallback ); }
	float GetTimeSpokeConcept( AIConcept_t conceptId )												{ return this->GetExpresser()->GetTimeSpokeConcept( concept ); }
	bool SpokeConcept( AIConcept_t conceptId )														{ return this->GetExpresser()->SpokeConcept( concept ); }
