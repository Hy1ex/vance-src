...
public:
...
#ifdef MAPBASE
	bool Speak( AIConcept_t conceptId, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen = NULL, size_t bufsize = 0, IRecipientFilter *filter = NULL );
...
#ifdef MAPBASE
	bool SpeakDispatchResponse( AIConcept_t conceptId, AI_Response *response, IRecipientFilter *filter = NULL, const AI_CriteriaSet *modifiers = NULL );
#else
	bool SpeakDispatchResponse( AIConcept_t conceptId, AI_Response *response, IRecipientFilter *filter = NULL );
#endif
	...
	bool CanSpeakConcept( AIConcept_t conceptId );
	bool SpokeConcept( AIConcept_t conceptId );
	float GetTimeSpokeConcept( AIConcept_t conceptId ); // returns -1 if never
	void SetSpokeConcept( AIConcept_t conceptId, AI_Response *response, bool bCallback = true );
	void ClearSpokeConcept( AIConcept_t conceptId );
...
public:
...
#ifdef MAPBASE
	virtual bool 	Speak( AIConcept_t conceptId, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen = NULL, size_t bufsize = 0, IRecipientFilter *filter = NULL );
#endif
	...
	AI_Response *	SpeakFindResponse( AIConcept_t conceptId, const AI_CriteriaSet& modifiers );
#endif
	bool 			SpeakDispatchResponse( AIConcept_t conceptId, AI_Response *response );
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::Speak( AIConcept_t conceptId, const AI_CriteriaSet& modifiers, char *pszOutResponseChosen /*=NULL*/, size_t bufsize /* = 0 */, IRecipientFilter *filter /* = NULL */ ) 
{
	AssertOnce( this->GetExpresser()->GetOuter() == this );
	return this->GetExpresser()->Speak( conceptId, modifiers, pszOutResponseChosen, bufsize, filter ); 
}
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline AI_Response *CAI_ExpresserHost<BASE_NPC>::SpeakFindResponse( AIConcept_t conceptId, const char *modifiers /*= NULL*/ )
{
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline AI_Response *CAI_ExpresserHost<BASE_NPC>::SpeakFindResponse( AIConcept_t conceptId, const AI_CriteriaSet& modifiers )
{
	return this->GetExpresser()->SpeakFindResponse( conceptId, modifiers );
}
#endif
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::SpeakDispatchResponse( AIConcept_t conceptId, AI_Response *response )
{
	if ( this->GetExpresser()->SpeakDispatchResponse( conceptId, response ) )
	{
