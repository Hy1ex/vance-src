...
public:
	...
	bool SpeakIfAllowed(const char *rrConcept, const char *modifiers = NULL);
...
//-----------------------------------------------------------------------------
bool CProtoSniper::SpeakIfAllowed(const char *rrConcept, const char *modifiers)
{
	if (!GetExpresser()->CanSpeakConcept(rrConcept))
		return false;

	return Speak(rrConcept, modifiers);
}
