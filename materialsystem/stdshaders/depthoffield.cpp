...
#include "depth_of_field_vs30.inc"
#include "depth_of_field_ps30.inc"
#include "convar.h"
...
BEGIN_VS_SHADER_FLAGS( DepthOfField, "Depth of Field", SHADER_NOT_EDITABLE )
	BEGIN_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( depth_of_field_vs30 );
			SET_STATIC_VERTEX_SHADER( depth_of_field_vs30 );

			DECLARE_STATIC_PIXEL_SHADER( depth_of_field_ps30 );
			SET_STATIC_PIXEL_SHADER( depth_of_field_ps30 );
		...
		DYNAMIC_STATE
		{
			DECLARE_DYNAMIC_VERTEX_SHADER( depth_of_field_vs30 );
			SET_DYNAMIC_VERTEX_SHADER( depth_of_field_vs30 );
			...
			DECLARE_DYNAMIC_PIXEL_SHADER( depth_of_field_ps30 );
			SET_DYNAMIC_PIXEL_SHADER_COMBO( QUALITY, params[QUALITY]->GetIntValue() );
			SET_DYNAMIC_PIXEL_SHADER( depth_of_field_ps30 );
		}
