...
#include "refract_helper.h"
#include "convar.h"
#include "sdk_refract_vs30.inc"
#include "sdk_refract_ps30.inc"
					 ...
					 IShaderShadow* pShaderShadow, Refract_DX9_Vars_t &info, VertexCompressionType_t vertexCompression )
{
	...
	SHADOW_STATE
	{
		...
		DECLARE_STATIC_VERTEX_SHADER( sdk_refract_vs30 );
		SET_STATIC_VERTEX_SHADER_COMBO( MODEL,  bIsModel );
		SET_STATIC_VERTEX_SHADER_COMBO( COLORMODULATE, bColorModulate );
		SET_STATIC_VERTEX_SHADER( sdk_refract_vs30 );

		DECLARE_STATIC_PIXEL_SHADER( sdk_refract_ps30 );
		...
		SET_STATIC_PIXEL_SHADER( sdk_refract_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( sdk_refract_vs30 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING,  pShaderAPI->GetCurrentNumBones() > 0 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
		SET_DYNAMIC_VERTEX_SHADER( sdk_refract_vs30 );

		DECLARE_DYNAMIC_PIXEL_SHADER( sdk_refract_ps30 );
		...
		SET_DYNAMIC_PIXEL_SHADER( sdk_refract_ps30 );
