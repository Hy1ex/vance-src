...
#include "sdk_unlittwotexture_ps30.inc"

// memdbgon must be the last include file in a .cpp file!!!
#include "tier0/memdbgon.h"

BEGIN_VS_SHADER( UnlitTwoTexture, "Help for UnlitTwoTexture" )
	BEGIN_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		...
		if ( bDrawStandardPass )
		{
			...
			SHADOW_STATE
			{
				...
				DECLARE_STATIC_PIXEL_SHADER( sdk_unlittwotexture_ps30 );
				SET_STATIC_PIXEL_SHADER_COMBO( TRANSLUCENT, bTranslucent );
				SET_STATIC_PIXEL_SHADER( sdk_unlittwotexture_ps30 );
			...
			DYNAMIC_STATE
			{
				...
				DECLARE_DYNAMIC_PIXEL_SHADER( sdk_unlittwotexture_ps30 );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( WRITE_DEPTH_TO_DESTALPHA, bFullyOpaque && pShaderAPI->ShouldWriteDepthToDestAlpha() );
				SET_DYNAMIC_PIXEL_SHADER( sdk_unlittwotexture_ps30 );
			}
			Draw();
		}
		else
