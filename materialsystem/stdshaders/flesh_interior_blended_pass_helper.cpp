...
#include "convar.h"
#include "flesh_interior_blended_pass_helper.h"
#include "sdk_flesh_interior_blended_pass_vs30.inc"
#include "sdk_flesh_interior_blended_pass_ps30.inc"
								  ...
								  IShaderShadow* pShaderShadow, FleshInteriorBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		SET_STATIC_VERTEX_SHADER( sdk_flesh_interior_blended_pass_vs30 );

		// Pixel Shader
		DECLARE_STATIC_PIXEL_SHADER( sdk_flesh_interior_blended_pass_ps30 );
		SET_STATIC_PIXEL_SHADER( sdk_flesh_interior_blended_pass_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( sdk_flesh_interior_blended_pass_vs30 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING, pShaderAPI->GetCurrentNumBones() > 0 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( DYNAMIC_LIGHT, lightState.HasDynamicLight() );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( STATIC_LIGHT, lightState.m_bStaticLight ? 1 : 0 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
		SET_DYNAMIC_VERTEX_SHADER( sdk_flesh_interior_blended_pass_vs30 );
		...
		DECLARE_DYNAMIC_PIXEL_SHADER( sdk_flesh_interior_blended_pass_ps30 );
		SET_DYNAMIC_PIXEL_SHADER( sdk_flesh_interior_blended_pass_ps30 );
