...
#include "sdk_engine_post_ps30.inc"
...
BEGIN_VS_SHADER_FLAGS( Engine_Post, "Engine post-processing effects (software anti-aliasing, bloom, color-correction", SHADER_NOT_EDITABLE )
	BEGIN_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		...
		SHADOW_STATE
		{
			...
			SET_STATIC_PIXEL_SHADER( sdk_engine_post_ps30 );
		}
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_PIXEL_SHADER( sdk_engine_post_ps30 );
			...
			SET_DYNAMIC_PIXEL_SHADER( sdk_engine_post_ps30 );
