	...
	else // not snapshotting -- begin dynamic state
	{
		...
		else
		{
			if ( bUseCSM )
			{
				...
				pShaderAPI->SetPixelShaderConstant( 36, csmData.vecLight.Base() );
				pShaderAPI->SetPixelShaderConstant( 37, csmData.light.Base() );
				pShaderAPI->SetPixelShaderConstant( 38, csmData.ambient.Base() );
				pShaderAPI->SetPixelShaderConstant( 39, biasVar.Base() );
				pShaderAPI->SetPixelShaderConstant( 40, textureSize.Base() );
				pShaderAPI->SetPixelShaderConstant( 41, csmData.sizes.Base() );
			}
		}
	}
	pShader->Draw();
